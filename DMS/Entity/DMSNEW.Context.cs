...
namespace DMS.Entity
{
    ...
    public partial class DMSNEWEntities : DbContext
    {
        public DMSNEWEntities()
            : base("name=DMSNEWEntities")
        {
        }
        ...
        public virtual IQueryable<fn_split_string_to_column_Result> fn_split_string_to_column(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_split_string_to_column_Result>("[DMSNEWEntities].[fn_split_string_to_column](@string, @delimiter)", stringParameter, delimiterParameter);
        }
    
        [DbFunction("DMSNEWEntities", "parseJSON")]
        public virtual IQueryable<parseJSON_Result> parseJSON(string jSON)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<parseJSON_Result>("[DMSNEWEntities].[parseJSON](@JSON)", jSONParameter);
        }
        ...
        public virtual ObjectResult<string> DMS_Login(string queryType, string emailid, string password, string passwordKey, Nullable<long> userId)
        {
            var queryTypeParameter = queryType != null ?
                new ObjectParameter("QueryType", queryType) :
                new ObjectParameter("QueryType", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("DMS_Login", queryTypeParameter, emailidParameter, passwordParameter, passwordKeyParameter, userIdParameter);
        }
        ...
        public virtual int DMS_IMPORTITEMGROUP(Nullable<long> createdBy, string groupCode, string groupName, string description)
        {
            var createdByParameter = createdBy.HasValue ?
                new ObjectParameter("CreatedBy", createdBy) :
                new ObjectParameter("CreatedBy", typeof(long));
