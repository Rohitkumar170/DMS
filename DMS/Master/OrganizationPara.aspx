<%@ Page Language="C#" MasterPageFile="~/DMS.Master" AutoEventWireup="true" CodeBehind="OrganizationPara.aspx.cs" Inherits="DMS.Master.OrganizationPara" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script src="../js/jquery-1.11.3.min.js" type="text/javascript"></script>
    ...
    <script src="../JavaScript/OrganizationSetup.js" type="text/javascript"></script>
    <script>
...
<input type="text" id="ddlcountry"  autocomplete="off"  style="width: 100px;"/>
    ...
    <div class="col-md-12 "> 
              ...
              <tbody>
                ...
                <td >  <input type="text" id="txtField_1" placeholder="Enter Parameter Name" class="parameter Name" onkeyup="Enablebutton(this)"  autocomplete="off" onkeypress="RemoveClass(this)" />  </td>
 <td >  <input type="text" id="ddlDatatype_1" placeholder="Enter Parameter Name" class="parameter Name" onkeyup=""  autocomplete="off" onkeypress="" />  </td>
    ...
    <div class="pdfexport">
                           ...
                           <button type="button"  id="btnsavepopupdata" class="btn btn-primary">
                            <i class="fa fa-save"></i> Submit</button>
                              ...
                              <table id="tblOrgpopupdata" class="table table-de mb-0">
                        <thead>
                            <tr>
                                 <%--<th>S. No.</th>--%>
...
<script>
    jquery_1_11_3_min_p(document).ready(function () {
        jquery_1_11_3_min_p("#submit").click(function () {
            jquery_1_11_3_min_p("#AllLeaveRequestPopup").show();
